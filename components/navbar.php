            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <a href="/lightning-revenue/" class="flex items-center">
                            <img src="/lightning-revenue/assets/images/logo-lightning-revenue.png" alt="Lightning Revenue" class="h-10 w-auto">
                        </a>
                    </div>
                </div>
